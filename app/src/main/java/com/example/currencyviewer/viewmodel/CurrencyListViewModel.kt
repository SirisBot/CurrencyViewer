...
import com.example.currencyviewer.viewmodel.RateApiState.Error
import com.example.currencyviewer.viewmodel.RateApiState.Success
import kotlinx.coroutines.launch

class CurrencyListViewModel(private val apiClient: RatesApiClient) : ViewModel() {

    private var _rateList: MutableLiveData<RateApiState> = MutableLiveData()
